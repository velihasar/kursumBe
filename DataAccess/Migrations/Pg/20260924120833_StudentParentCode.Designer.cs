...
namespace DataAccess.Migrations.Pg
{
    ...
    [Migration("20260924120833_StudentParentCode")]
    partial class StudentParentCode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Project.CanteenProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Project.StudentWallet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Project.StudentWalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("StudentWalletId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Project.Parent", b =>
                {
                    b.HasOne("Core.Entities.Concrete.Project.Person", "Person")
                        .WithOne("Parent")
                        .HasForeignKey("Core.Entities.Concrete.Project.Parent", "PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Project.Student", b =>
                {
                    b.HasOne("Core.Entities.Concrete.Project.Person", "Person")
                        .WithOne("Student")
                        .HasForeignKey("Core.Entities.Concrete.Project.Student", "PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Project.StudentWalletTransaction", b =>
                {
                    b.HasOne("Core.Entities.Concrete.Project.CanteenProduct", "CanteenProduct")
                        .WithMany()
                    ...
                    b.HasOne("Core.Entities.Concrete.Project.StudentWallet", "StudentWallet")
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Project.Teacher", b =>
                {
                    b.HasOne("Core.Entities.Concrete.Project.Person", "Person")
                        .WithOne("Teacher")
                        .HasForeignKey("Core.Entities.Concrete.Project.Teacher", "PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
